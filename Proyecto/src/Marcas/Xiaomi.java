...
public class Xiaomi {
	...
	private void initialize() {
		...
		Panel_xiaomi = new JPanel();
		Panel_xiaomi.setBackground(Color.WHITE);
		Panel_xiaomi.setBounds(183, 181, 840, 672);
		frame.getContentPane().add(Panel_xiaomi);
		Panel_xiaomi.setLayout(null);
		...
		Panel_xiaomi.add(Xiaomi_mi10pro);
		...
		JL_Xiaomi_mi10pro.setBounds(40, 179, 150, 34);
		Panel_xiaomi.add(JL_Xiaomi_mi10pro);
