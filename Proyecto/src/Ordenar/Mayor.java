...
public class Mayor {
	...
	private void initialize() {
		...
		Panel_mayor = new JPanel();
		Panel_mayor.setBackground(Color.WHITE);
		Panel_mayor.setBounds(183, 181, 840, 672);
		frame.getContentPane().add(Panel_mayor);
		Panel_mayor.setLayout(null);
		
		JButton Iphone7_plata = new JButton("");
		Iphone7_plata.setBounds(246, 224, 150, 157);
		...
		JL_Iphone7_plata.setBounds(246, 392, 150, 34);
		Panel_mayor.add(JL_Iphone7_plata);
		...
		Panel_mayor.add(JL_IphoneX_negro);
		
		JButton Xiaomi_mi9 = new JButton("");
		Xiaomi_mi9.setBackground(Color.WHITE);
		Xiaomi_mi9.setBounds(40, 224, 150, 157);
		...
		JL_Xiaomi_mi9.setBounds(40, 392, 150, 34);
		Panel_mayor.add(JL_Xiaomi_mi9);
		...
		Panel_mayor.add(Xiaomi_mi10pro);
		...
		Panel_mayor.add(JL_Xiaomi_mi10pro);
